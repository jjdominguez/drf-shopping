...
urlpatterns = [
    ...
    path('api/shopping-lists/<uuid:pk>/add-members/', ShoppingListAddMembers.as_view(),
         name="shopping-list-add-members"),
    path('api/shopping-lists/<uuid:pk>/remove-members/', ShoppingListRemoveMembers.as_view(),
